...
<!--Codigo php-->
  <?php
    ...
    $link = mysqli_connect('localhost','root','','contabilidad') or die("Hubo uno erro al conectar la base de datos".mysqli_error());

    // query a usar 
    $query = "DELETE FROM cuentascontables WHERE NumCuenta = $codigo";
    ...
    <div class='row justify-content-center'>
        <div class='col-md-8'>
            <div class='alert alert-success alert-dismissible fade show shadow-sm' role='alert'>
                ...
                <strong>¡Éxito!</strong> La cuenta contable ha sido eliminada correctamente.
